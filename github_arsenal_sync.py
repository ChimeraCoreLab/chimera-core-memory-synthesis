...
REPO_MAP = {
    ...
    "noice-notice-nice-artifact": {
        "tree_style": 1,
        "gallery": "PROJECT_GALLERIES.pyramid",
        "thumb": 0
    },
    "haunted-hole": {
        "tree_style": 1,
        "gallery": "PROJECT_GALLERIES.hauntedHole",
        "thumb": 21
    },
    ...
    "hoop-city-9000-nexus": {
        "tree_style": 1,
        "gallery": "PROJECT_GALLERIES.hoopct",
        "thumb": 0
    },
    "Joise-Character-Model": {
        "tree_style": 1,
        "gallery": "PROJECT_GALLERIES.JOSI1",
        "thumb": 0
    },
    "Philosophical-Chat-WebApp": {
        "tree_style": 1,
        "gallery": "PROJECT_GALLERIES.PACW",
        "thumb": 0
    },
    "Architect-of-Intelligence-Godot": {
        "tree_style": 2,
        "gallery": "PROJECT_GALLERIES.archOfIntel",
        "thumb": 0
    },
    "MFU-Portfolio-Video-Godot-Project": {
        "tree_style": 2,
        "gallery": "PROJECT_GALLERIES.MFU",
        "thumb": 0
    },
    "national-artist-tribute-godot": {
        "tree_style": 2,
        "gallery": "PROJECT_GALLERIES.NATIONART",
        "thumb": 0
    },
    "Godot-3.6-beta2-Eleva-Horror-Game": {
        "tree_style": 2,
        "gallery": "PROJECT_GALLERIES.ELV",
        "thumb": 0
    },
    "Advanced-Chatbot-Blueprint": {
        "tree_style": 1,
    ...
    "Godot-4.3-Enemy-Moves-To-Player-Dark-Env": {
        "tree_style": 2,
        "gallery": "PROJECT_GALLERIES.archOfIntel",
        "thumb": 1
    },
...
def sync_arsenal():
    print(f"[SYSTEM] Connecting to GitHub Uplink for user: {GITHUB_USER}...")
    try:
    ...
    for r in repos:
        ...
        tree_items = get_tree_data(GITHUB_USER, name, branch)
        
        if config['tree_style'] == 1:
            tree_str = format_tree_full(tree_items)
        else:
    ...
    with open('extracted_github_logs.txt', 'w', encoding='utf-8') as f:
        f.write("\n".join(raw_logs))
    print(f"\n[SUCCESS] Distillation complete. {len(repos)} Repositories saved to 'extracted_github_logs.txt'.")
